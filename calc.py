...
def calc():
    ...
    if len(list11_0)==0:
        list11.append('11360');list12.append('12360');list13.append('13360');list14.append('14360');list15.append('15360');list11_0.append('11360')
    elif len(list12)==0:
        list11.append('11360');list12.append('12360');list13.append('13360');list14.append('14360');list15.append('15360');list11_0.append('11360')
    elif len(list13)==0:
        list11.append('11360');list12.append('12360');list13.append('13360');list14.append('14360');list15.append('15360');list11_0.append('11360')
    ...
    if len(list21_0)==0 and len(list22)==0:
        list21.append('21370');list22.append('22370');list23.append('23370');list21_0.append('21370')
    ...
    if len(list31)==0 and len(list32)==0:
        list31.append('31380');list32.append('32380');list33.append('33380');list33_0.append('33380')
    ...
    if len(list21_0)==0:
        list21.append('21370');list21_0.append('21370')
    if len(list22)==0:
        list22.append('22370')
    if len(list23)==0:
        list23.append('23370')
    ...
    if len(list32)==0:
        list32.append('32380')
    if len(list33_0)==0:
        list33.append('33380');list33_0.append('33380')
            ...
            if len(all_list_god)!=0:
                for calc_now in all_list_god:
                    ...
                    if setopt_num >= max_setopt-set_perfect :
                        ...
                        final_damage=actlvl*damage*((100/(100-coolper)-1)*cool_eff*cool_on+1)
...
def reset():
    ...
    for i in range(1101,3336):
        ...
        try:
            ...
            passss=1
    for i in know_list2+know_set_list:
...
def know_epic():
    ...
    know_window.geometry("545x355+750+20")
    know_window.resizable(False, False)
    know_window.configure(bg=dark_main)
    know_image_list={}
    for i in know_list+know_set_list:
